...
class RecipientSignUp extends StatefulWidget {
  ...
  @override
  State<RecipientSignUp> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<RecipientSignUp> {
        ...
        child: Center(
          child: ListView(
            children: [
              ...
              Center(
                  child: Text("Make a pad request and get comfortable...",
                      style: TextStyle(
                          fontSize: 12,
              ...
              SizedBox(
                height: 60,
                child: CustomTextField(
                  hintText: 'Shekinah Pharmacy',
                  labelText: 'Closest Pharmacy to you',
